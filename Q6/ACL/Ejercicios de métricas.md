...
| Fórmula:               | TiempoRealTareasCríticas / TiempoPlanificadoTareasCríticas x 100                                                                                              |
| Unidad de medida:      | %                                                                                                                                                             |
| Origen de los datos:   | Plan de proyecto                                                                                                                                              |
| Periocididad:          | Seguimiento                                                                                                                                                   |
| Criterios de análisis: | Un porcentaje mayor al 100% indica desviaciones en las tareas críticas y, por tanto, aumento de la duración del camino crítico y de la duración del proyecto. |
$\space$
